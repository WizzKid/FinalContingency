...
public class HealHealthBar : MonoBehaviour
{
	...
	//Reference to the HealHealthBar, where its fillAmount can be edited
	[SerializeField]
	...
	//HealHealthStat sends value update, which is formatted here for conversion to 0 - 1 range for fillAmount slider
	public float Value
	{
		set
		{
	...
	//HealHealthBar updates every frame
	void Update ()
	{
		HandleBar();
	}
