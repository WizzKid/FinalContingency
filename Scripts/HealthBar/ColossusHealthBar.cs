...
public class ColossusHealthBar : MonoBehaviour
{
	...
	//ColossusHealthStat sends value update, which is formatted here for conversion to 0 - 1 range for fillAmount slider
	public float Value
	{
		set
		{
	...
	//ColossusHealthBar updates every frame
	void Update ()
	{
		HandleBar();
	}
